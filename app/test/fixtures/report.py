...
def mocked_most_requested_ingredient_strategy(most_requested_ingredient_report):
    with patch(
        "app.repositories.reports.report_strategy.MostRequestedIngredientStrategy.generate",
...
def mocked_month_with_most_revenue_strategy(month_with_most_revenue_report):
    with patch(
        "app.repositories.reports.report_strategy.MonthWithMostRevenueStrategy.generate",
...
def mocked_top_customers_strategy(top_customers_report):
    with patch(
        "app.repositories.reports.report_strategy.TopCustomersStrategy.generate",
