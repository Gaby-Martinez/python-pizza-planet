...
class Order(db.Model):
    ...
    size = db.relationship("Size", backref="orders")
    ingredients = db.relationship("OrderIngredient", backref="order")
    beverages = db.relationship("OrderBeverage", backref="order")
...
class OrderIngredient(db.Model):
    ...
    ingredient = db.relationship("Ingredient", backref="order_ingredients")
...
class OrderBeverage(db.Model):
    ...
    beverage = db.relationship("Beverage", backref="order_beverages")
